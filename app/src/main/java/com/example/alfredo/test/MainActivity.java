package com.example.alfredo.test;
...
public class MainActivity extends ActionBarActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        private ArrayAdapter<String> listForecastAdapter;
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            listForecast.add(";d;sf;sd;f;s;dsf;sd;");
            listForecast.add("asdfasdfasdf");
            listForecast.add("ffffdfdsdf");
            listForecast.add("werwerwperpewpr");
            listForecast.add(";d;sf;sd;f;s;dsf;sd;");
            ...
            listView.setAdapter(listForecastAdapter);
